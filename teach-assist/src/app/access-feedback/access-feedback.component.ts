...
@Component({
  ...
  styleUrl: './access-feedback.component.css'
})
export class AccessFeedbackComponent {
  summary =  `Why Memory Management?
  ...
  Early Systems – No Memory Abstraction <br />
  - Programs referenced physical memory directly, e.g., MOV REGISTER, 1000.<br />
  - Achieved multiprogramming by swapping processes between memory and disk.<br />
